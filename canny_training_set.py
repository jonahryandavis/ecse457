...
plt.savefig('./images/Original_Edge.jpg')
...
plt.savefig('./images/Sobel_derivatives.jpg')
...
plt.savefig('./images/Training_Set_edge.jpg')
...
plt.xticks(())
plt.yticks(())
plt.savefig('./images/Logistic_datapoints.jp')
...
plt.savefig('./images/Canny_Logistic.jpg')
...
plt.savefig('./images/Img23_Original_Logistic.jpg')
